                    ...
                    <div class="col-md-4">
                        <div class="card flex-md-row mb-4 shadow-sm h-md-250">
                            <div class="card-body d-flex flex-column align-items-start">
                                ...
                                <small class="card-text mb-auto">{{$job->title}}</small>
                ...
                <div class="col mx-auto">
                    ...
                    @foreach($myJobs as $myJob)
                        <div class="col-md-3">
                            <div class="card flex-md-row mb-4 shadow-sm h-md-250">
                                <div class="card-body d-flex flex-column align-items-start">
                                    <strong class="d-inline-block mb-2 text-primary">{{$myJob->company->name}}</strong>
                                    <p class="mb-0">
                                        <a class="text-dark" href="#">{{$myJob->job->title}}</a>
                                    </p>
